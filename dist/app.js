...
Details: ${t.message}`;
  ...
  var Wt = function({ rootEnvPath: e, schemaEnvPath: t }, r = { conflictCheck: "none" }) {
    let n = zo(e);
...
`);
  ...
  var ot = function({ error: e, user_facing_error: t }, r, n) {
...
`);
  ...
  var Fp = function({ message: e, originalMethod: t, isPanic: r, callArguments: n }) {
    return { functionName: `prisma.${t}()`, message: e, isPanic: r ?? false, callArguments: n };
  };
  var Np = function({ callsite: e, message: t, originalMethod: r, isPanic: n, callArguments: i }, o) {
  ...
  var qp = function({ functionName: e, location: t, message: r, isPanic: n, contextLines: i, callArguments: o }, s) {
    let a = [""], l = t ? " in" : ":";
...
`);
  ...
  var ra = function({ result: e, modelName: t, select: r, omit: n, extensions: i }) {
  ...
  var bn = function({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
    if (Array.isArray(t)) {
  ...
  var na = function({ includeOrSelect: e, result: t, parentModelName: r, runtimeDataModel: n, visitor: i }) {
  ...
  var ia = function({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
...
`)), c?.kind === "batch" && await c.lock, this._requestHandler.request({ protocolQuery: h, modelName: l, action: a, clientMethod: i, dataPath: o, callsite: s, args: n, extensions: this._extensions, transaction: c, unpacker: p, otelParentCtx: d, otelChildCtx: this._tracingHelper.getActiveContext(), globalOmit: this._globalOmit, customDataProxyFetch: f });
  ...
  var __dirname = "C:\\Users\\renato\\Desktop\\express-vercel\\node_modules\\@prisma\\client\\runtime", __filename = "C:\\Users\\renato\\Desktop\\express-vercel\\node_modules\\@prisma\\client\\runtime\\library.js";
  ...
  var Mo = Z((Xm, No) => {
    var _u = __require("os"), Fo = __require("tty"), de = Kn(), { env: Q } = process, Ue;
  ...
  var Ho = Z((Df, Jr) => {
    var Vu = __require("fs"), Wo = __require("path"), Bu = __require("os"), Uu = Jo(), Gu = Uu.version, Qu = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
    function Ju(e) {
      let t = {}, r = e.toString();
      r = r.replace(/\r\n?/mg, `
`);
...
`), o = o.replace(/\\r/g, "\r")), t[i] = o;
  ...
  var Co = k(__require("child_process"));
  var Jn = k(__require("fs/promises"));
  var Vr = k(__require("os"));
  ...
  var ni = k(__require("fs"));
  var Qo = F("chmodPlusX");
  var li = k(Ho());
  var Wr = k(__require("fs"));
...
${(0, is.default)(ec(n), 2)}
  ...
  var Nl = k(ti());
  var Ml = __require("async_hooks");
  var $l = __require("events");
  var ql = k(__require("fs"));
  var kr = k(__require("path"));
  var ie = class e {
    constructor(t, r) {
...
${r}`, A(n, true));
  ...
  w(Tr, "RequestError");
  var fd = typeof __require < "u" ? __require : () => {
  };
  var Wi = class {
    constructor(t = {}) {
  ...
  var Yi = k(__require("os"));
  var Ba = k(__require("path"));
...
var require_client = __commonJS((exports) => {
  ...
  var config2 = {
    generator: {
      ...
      output: {
        value: "C:\\Users\\renato\\Desktop\\express-vercel\\node_modules\\@prisma\\client",
        fromEnvVar: null
      },
      config: {
        engineType: "library"
      ...
      previewFeatures: [],
      sourceFilePath: "C:\\Users\\renato\\Desktop\\express-vercel\\prisma\\schema.prisma"
    },
    relativeEnvPaths: {
      rootEnvPath: null,
      schemaEnvPath: "../../../.env"
    ...
    inlineSchemaHash: "95a13c0aa443355e298bb1deded7f47c93f800354546c98a59e06b85c81857f6",
    copyEngine: true
  };
  var fs = __require("fs");
...
router2.use("/product", product_default);
...
var corsConfig = ({ acceptedOrigins = ACCEPTED_ORIGINS } = {}) => {
  const corsOptions = {
    origin: (origin, cb) => {
      if (!origin) {
        return cb(null, true);
  ...
  return import_cors.default(corsOptions);
};
